...
}},{key:'recordCustomEventWithName',value:function recordCustomEventWithName(
...
eventType,eventName,args){
var eventTypeStr=String(eventType);
var eventNameStr=String(eventName);
var argsIsObject=(typeof args==='undefined'?'undefined':_typeof(args))==='object';
var argsStr=argsIsObject?
Object.keys(args).reduce(function(argsObject,key){
var value=args[key];
...
}},{key:'recordCustomEvent',value:function recordCustomEvent(
